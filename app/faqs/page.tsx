...
const FAQs = () => {
  ...
  return (
    <>
      <section
        className="px-10 sm:px-30 py-15 mb-15 mt-24 max-w-7xl mx-auto"
        id="faqs"
      >
        {/* above text */}
        <div className="flex flex-col justify-center items-center md:items-start py-5 sm:py-10 lg:px-10">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-center md:text-start">
            {t.heading}
          </h1>
          <p className="text-center md:text-start mt-5 text-sm sm:text-base md:text-lg text-[#495057]">
            {t.desc}
          </p>
        </div>
        {/* FAQ Items */}
        <div className="flex flex-col gap-4 text-black md:px-10 lg:px-20">
